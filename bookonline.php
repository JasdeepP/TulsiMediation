...
<cms:template title='Book Online' icon='book'> 
							...
							<!-- Content -->
								<section>
									...
									<!-- Content -->
										...
										<p style="font-size:28px"><b>Get in touch with us, Fill out the form below to reach out to us.</b></p>
									<hr class="major" />

									<!--Section (Form)-->
									<section>
										<h3>Form</h3>
										<form action="mailto:jasdeeppanesar49@yahoo.com" method="post" enctype="text/plain">
											Name:<br>
											<input type="text" name="name"><br>
											E-mail:<br>
											<input type="text" name="mail"><br>
											Gender:
											<select name="Gender" placeholder="Gender"><option><option>Male<option>Female</select><br>
											Comment:<br>
