...
<cms:template title='Services' icon='list'> 
...
<cms:editable
    ...
    label='Service Heading 1'
    type='text'
/>
<cms:editable
    name='facilitativemediation'
    label='Facilitative Mediation'
    type='text'
/>

<cms:editable
    name='serviceheading2'
    label='Service Heading 2'
    type='text'
/>
<cms:editable
    name='courtmandated'
    label='Court-Mandated Mediation'
    type='text'
/>

<cms:editable
    name='serviceheading3'
    label='Service Heading 3'
    type='text'
/>
<cms:editable
    name='evaluativemediation'
    label='Evaluative Mediation'
    type='text'
/>

<cms:editable
    name='serviceheading4'
    label='Service Heading 4'
    type='text'
/>
<cms:editable
    name='transformativemediation'
    label='Transformative Mediation'
    type='text'
/>

<cms:editable
    name='serviceheading5'
    label='Service Heading 5'
    type='text'
/>
<cms:editable
    name='medarb'
...
<cms:editable
    name='serviceheading6'
    label='Service Heading 6'
    type='text'
/>
<cms:editable
    name='emediation'
							...
							<!-- Content -->
								<section>
									...
									<!-- Content -->
										...
										<h4 align="center"><cms:show serviceintro/></h4>
									<hr class="major" />
									...
									<section>
										<div class="features">
											<article>
												...
												<div class="content">
													<h4><cms:show serviceheading1/></h4>
													<p><cms:show facilitativemediation/></p>
												</div>
											</article>
											<article>
												<span class="icon solid fa-handshake"></span>
												<div class="content">
													<h4><cms:show serviceheading2/></h4>
													<p><cms:show courtmandated/></p>
												</div>
											</article>
											<article>
												<span class="icon solid fa-users"></span>
												<div class="content">
													<h4><cms:show serviceheading3/></h4>
													<p><cms:show evaluativemediation/></p>
												</div>
											</article>
											<article>
												<span class="icon solid fa-book"></span>
												<div class="content">
													<h4><cms:show serviceheading4/></h4>
													<p><cms:show transformativemediation/></p>
												</div>
											</article>
											<article>
												<span class="icon solid fa-circle"></span>
												<div class="content">
													<h4><cms:show serviceheading5/></h4>
													<p><cms:show medarb/></p>
												</div>
											</article>
											<article>
												...
												<div class="content">
													<h4><cms:show serviceheading6/></h4>
													<p><cms:show emediation/></p>
												</div>
											</article>
										</div>
									</section>
